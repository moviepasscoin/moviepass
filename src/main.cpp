...
#if defined(NDEBUG)
# error "MoviePass cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "MoviePass Signed Message:\n";
...
{
	int64_t halvings = pindexPrev->nHeight / 2000;
...
{
    RenameThread("moviepass-loadblk");
